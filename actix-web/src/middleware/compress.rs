...
impl Compress {
    ...
    pub fn deflate_level(mut self, value: u32) -> Self {
        Arc::get_mut(&mut self.inner).unwrap().deflate = Some(value);
        self
    }
    ...
    pub fn gzip_level(mut self, value: u32) -> Self {
        Arc::get_mut(&mut self.inner).unwrap().gzip = Some(value);
        self
    }
    /// Set gzip compression level.
    ///
    ...
    pub fn brotli_level(mut self, value: u32) -> Self {
        Arc::get_mut(&mut self.inner).unwrap().brotli = Some(value);
        self
    }
    /// Set gzip compression level.
    ///
    ...
    pub fn zstd_level(mut self, value: u32) -> Self {
        Arc::get_mut(&mut self.inner).unwrap().zstd = Some(value);
        self
    }
}
